        ...
        >
            ...
            className="relative w-[90%] h-[400px] max-w-[500px] bg-[#00000069] backdrop-blur shadow-black flex flex-col items-center justify-center gap-5 px-5">
                ...
                <input
                    ...
                    className="w-full h-10 outline-none border border-white bg-transparent text-white placeholder-gray-200 px-5 rounded-full text-lg" required onChange={(e)=>setName(e.target.value)}
                    value={name}
                />
              ...
              <button type='submit' className='min-w-[150px] h-12 mt-2 text-black font-semibold bg-white rounded-full text-base' disabled={loading}>{loading ? "Signing Up..." : "Sign Up"}</button> 
              <p className="text-white text-lg cursor-pointer" onClick={() => navigate("/signin")}>Already have an account? <span className="text-blue-400">Sign In</span></p>
